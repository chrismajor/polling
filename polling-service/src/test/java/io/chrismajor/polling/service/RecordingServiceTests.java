...
import io.chrismajor.polling.PollingServiceApplication;
...
@SpringBootTest
@ContextHierarchy(@ContextConfiguration(classes = PollingServiceApplication.class))
